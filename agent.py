...
def get_conversation_agent(student_level: int = 5):
    ...
    return Agent(
        ...
        - Track what information has already been REVEALED, not just what themes were discussed.
          Example: if the student said they like the characters, do not ask about characters again.
        - After 2 exchanges on any one sub-topic, steer to a completely new angle.
        ...
        Bad progression (never do this):
          Turn 2: What do you like about the show?
          Turn 3: What's your favourite character?  ← still about the show details
          Turn 4: What's the character like?        ← repeating characters sub-topic
...
def get_coaching_agent(student_level: int = 5):
    ...
    return Agent(
        ...
        - Do NOT rewrite just because a slightly different phrasing exists.
        - Do NOT correct factual statements, opinions, or personal preferences.
        - Do NOT change the student's intended meaning.
        - Short simple sentences are natural — do NOT call them "short and abrupt".
        ...
        - "It's fast moving." → natural, do not rewrite
        - "I will relax at home." → natural, do not rewrite
        - "I like the characters and the action." → natural, do not rewrite

        If the comment would be "this is a bit short" or "this sounds abrupt" — do NOT
        say that. Either find a specific genuine improvement or praise and move on.
